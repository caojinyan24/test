...
public class QNettyClient {
    ...
    public void start(int workerThreadNum, boolean ePoll, String host, int port) {
        _workerGroup = QNettyUtils.createEventLoopGroup(ePoll, workerThreadNum, "netty-client-thread-%d");
        ...
        // 设置SocketChannel
        bootstrap.channel(QNettyUtils.getClientChannelClass(ePoll));
        // 设置Socket选项
...
//                p.addLast(new StringDecoder());
    ...
    public static void main(String[] args) throws Exception {
        String host = QNettyUtils.getIpV4();
        QNettyClient client = new QNettyClient();
